    ...
    <Container>
      <Content>
        <HeadingInfoContainer>
          <HeadingTitle>Who uses DefiHedge?</HeadingTitle>
        ...
        <TestimonialSliderContainer>
          <TestimonialSlider nextArrow={<NextArrow />} prevArrow={<PreviousArrow />}>
			  <Testimonial>
				<ImageContainer>
					<img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=3.25&w=512&h=512&q=80" />
				</ImageContainer>
				<TextContainer>
				  <QuoteContainer>
