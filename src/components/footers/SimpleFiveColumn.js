      ...
      <FiveColumns>
        <WideColumn>
          <LogoContainer>
            ...
            <LogoText>DefiHedge Corporation</LogoText>
          </LogoContainer>
          <CompanyDescription>
            DefiHedge aims to provide the infrastructure necessary to push towards the next growth phase of decentralized finance. 
          </CompanyDescription>
          <SocialLinksContainer>
            <SocialLink href="https://www.facebook.com/DefiHedge/">
              <FacebookIcon />
            </SocialLink>
            <SocialLink href="https://twitter.com/TraversaJulian">
              <TwitterIcon />
            </SocialLink>
