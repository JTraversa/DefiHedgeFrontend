...
import logoImageSrc from "images/logo-white.svg";
...
export default ({
  heading = "The Protocol For Interest-Rate Derivatives",
  description = "As the first and only protocol to facilitate trustless interest-rate swaps, DefiHedge provides lenders the ability to lend at fixed-rates and maximize yields with leveraged lending positions.",
  ...
  const navLinks = [
    <NavLinks key={1}>
      ...
      <PrimaryLink href="#">Whitepaper</PrimaryLink>
    </NavLinks>
  ];
  return (
