...
const PrimaryLink2 = tw(PrimaryLinkBase)`h-12 mt-16 shadow-raised lg:bg-primary-400 lg:hocus:bg-primary-500`;
const SecondaryLink = tw(PrimaryLinkBase)`h-12 sm:mt-12 sm:ml-8 bg-gray-300 text-gray-800 hocus:bg-gray-400 hocus:text-gray-900`;
